const Footer = () => {
    return (
        <footer className="p-10 bg-cyan-800 text-white">
            <div className="footer max-w-6xl mx-auto">
                <aside>
                    ...
                    <p>TutorMatch<br />Connecting learners and educators</p>
                </aside>
                <nav>
                    <header className="footer-title">Services</header>
                    <a className="link link-hover">Online Tutoring</a>
                    <a className="link link-hover">Course Materials</a>
                    <a className="link link-hover">Study Resources</a>
                    <a className="link link-hover">Interactive Learning</a>
                </nav>
                <nav>
